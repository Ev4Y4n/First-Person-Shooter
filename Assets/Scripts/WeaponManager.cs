...
public class WeaponManager : MonoBehaviour
{
    ...
    private void PickupThrowableAsTactical(Throwable.ThrowableType tactical)
    {
        if (equippedTacticalType == tactical || equippedTacticalType == Throwable.ThrowableType.None)
        {
            ...
            {
                tacticalCount += 1;
                Destroy(InteractionManager.THIS.hoveredThrowable.gameObject);
                HUDManager.THIS.UpdateThrowablesUI();
            }
            else
            {
        ...
        {
            //no puede coger otro tactical 
            //opcion de cambiar el tactical
        }
    }
    ...
    private void PickupThrowableAsLethal(Throwable.ThrowableType lethal)
    {
        ...
        {
            //no puede coger otro lethal
            //opcion de cambiar el lethal
        }
    }
